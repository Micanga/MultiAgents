...
# 1. Defining the Graph Generation Parameters ['outputs']#
...
def plot_type_probability(aga_tp, abu_tp, pf_tp, threshold, plotname):
	...
	pf_error  = np.array([pf_error[t]+0.3  for t in range(threshold)])
...
def plot_run_length_bar(aga_m,aga_s,abu_m,abu_s,pf_m,pf_s,plotname):
    ...
    # PF
    pf=axis.bar(3,height = pf_m-60,width= bar_w,yerr = pf_s-pf_m, color='#F66095')
